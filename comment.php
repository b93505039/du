...
?>
	...
	<tr class="list">
   		<td colspan="3" width="512" height="60" align="center">
<?php
		if($nowdid == $row['id']){
?>
			<form name="form" method="post" action="updateComment.php">
				<input type=hidden name=pid value="<?php echo $pid;?>">
				<input type=hidden name=did value="<?php echo $did;?>">
				<textarea name="content" rows="4" cols="60" maxlength="100" style="background-color:tan; resize:none;"><?php echo $row['comment']?></textarea>
				<br><input type="submit" name="Submit" value="確定">
			</form>
